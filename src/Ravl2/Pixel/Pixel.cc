...
namespace Ravl2
{
  ...
  std::istream &operator>>(std::istream &strm, ImageChannel &channel)
  {
    ...
    else if(str == "Green") channel = ImageChannel::Green;
    else if(str == "Blue") channel = ImageChannel::Blue;
    else if(str == "Alpha") channel = ImageChannel::Alpha;
    else if(str == "Luminance") channel = ImageChannel::Luminance;
    else if(str == "ChrominanceU") channel = ImageChannel::ChrominanceU;
    else if(str == "ChrominanceV") channel = ImageChannel::ChrominanceV;
    else if(str == "Intensity") channel = ImageChannel::Intensity;
    else if(str == "Luminance2") channel = ImageChannel::Luminance2;
    else if(str == "Hue") channel = ImageChannel::Hue;
    else if(str == "Saturation") channel = ImageChannel::Saturation;
    else if(str == "Value") channel = ImageChannel::Value;
    else if(str == "Lightness") channel = ImageChannel::Lightness;
    else if(str == "Count") channel = ImageChannel::Count;
    else if(str == "Label") channel = ImageChannel::Label;
    else if(str == "Depth") channel = ImageChannel::Depth;
    else if(str == "Signal") channel = ImageChannel::Signal;
    // else if(str == "Unused") channel = ImageChannel::Unused;
    else channel = ImageChannel::Unused;
    return strm;
  }
