...
namespace Ravl2
{
  ...
  */
  ...
  namespace
  {
    ...
    [[maybe_unused]] bool g_reg25 = registerConversion(convert<Array<PixelI8, 2>, Array<PixelY8, 2>>, 1.0f);
    [[maybe_unused]] bool g_reg26 = registerConversion(convert<Array<PixelY8, 2>, Array<PixelI8, 2>>, 1.0f);
