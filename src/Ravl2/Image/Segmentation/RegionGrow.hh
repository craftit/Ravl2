...
namespace Ravl2
{
  ...
  template <class PixelSelectorT, class ClassifierT, class PixelT, class StatT>
  class RegionGrowBodyC : public SegmentRegionBodyC<PixelT, StatT>
  {
  public:
    RegionGrowBodyC()
  ...
  template <class PixelSelectorT, class ClassifierT, class PixelT, class StatT>
  class RegionGrowC : public SegmentRegionC<PixelT, StatT>
  {
  public:
    RegionGrowC()
        : SegmentRegionC<PixelT, StatT>(*new RegionGrowBodyC<PixelSelectorT, ClassifierT, PixelT, StatT>())
    {}
    //: Default constructor

    RegionGrowC(const ClassifierT &cl)
        : SegmentRegionC<PixelT, StatT>(*new RegionGrowBodyC<PixelSelectorT, ClassifierT, PixelT, StatT>(cl))
    {}
    //: Construct from a classifier
